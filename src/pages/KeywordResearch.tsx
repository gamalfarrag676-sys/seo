...
const getIntentColor = (intent: string) => {
 ...
 if (normalized.includes('transactional')) return 'bg-blue-50 text-blue-700 border-blue-200';
...
export default function KeywordResearch() {
 ...
 <th className="p-4 font-semibold text-gray-600">الكلمة المفتاحية</th>
 ...
 <th className="p-4 font-semibold text-gray-600">نية البحث</th>
 <th className="p-4 font-semibold text-gray-600">
 <div className="flex items-center gap-2">
 ...
 <td className="p-4 font-medium text-gray-700">{item.keyword}</td>
 <td className="p-4 text-gray-600">{item.volume}</td>
 ...
 <td className="p-4 text-gray-600">{item.cpc}</td>
 </tr>
 ))}
 </tbody>
 </table>
