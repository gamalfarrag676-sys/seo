...
export default function ProductGenerator() {
 ...
 <div className="inline-flex items-center justify-center p-4 bg-blue-500/10 rounded-2xl ring-1 ring-blue-500/30 mb-4">
 ...
 />
 <p className="text-xs text-gray-400 mt-1">💡 أضف وصفاً دقيقاً للمنتج ليستخدمه الذكاء الاصطناعي كمرجع أساسي</p>
 </div>
 ...
 className="w-full btn btn-primary text-gray-900"
 >
 ...
 {publishStatus && (
 <div className={`card p-4 text-sm flex items-center gap-2 ${publishStatus.success
 ...
 <p className="text-sm text-gray-600 mt-2">ارفع صورة المنتج وأدخل الكلمة المفتاحية</p>
 </div>
 )}
 </div>
