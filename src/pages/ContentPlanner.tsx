...
const getTypeColor = (type: string) => {
 ...
 if (normalized.includes('category') || normalized.includes('تصنيف')) return 'bg-blue-50 text-blue-700 border-blue-200';
...
export default function ContentPlanner() {
 ...
 className="flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-gray-600 transition-colors"
 >
 ...
 <div key={cIdx} className="card p-6 border-t-4 border-t-blue-500/50">
 ...
 <h3 className="font-semibold text-gray-700 text-lg group-hover:text-blue-500 transition-colors">
 {node.title}
 </h3>
 ...
 <div className="text-sm text-gray-600 bg-black/20 px-3 py-2 rounded-md">
 {node.intent}
 </div>
 </div>
 </div>
