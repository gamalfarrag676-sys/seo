    ...
    <div className="glass-card overflow-hidden">
      ...
      >
        <div className="flex items-center gap-4">
          <div className="relative w-14 h-14 shrink-0 flex flex-col items-center justify-center bg-slate-900 rounded-xl border border-slate-700/50 shadow-inner">
             <span className={clsx(
                "text-2xl font-black",
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">معايير جوجل للجودة والمصداقية</p>
          </div>
        </div>
      ...
      <div className={clsx(
        ...
        <div className="p-4 sm:p-5 space-y-6">
          ...
          <div className="space-y-4">
            {categories.map(cat => (
              <div key={cat.id} className="bg-slate-900/40 rounded-xl p-4 border border-slate-800/50">
                {/* Category Header */}
                ...
                <div className="space-y-2 mt-3">
                  {cat.factors.map(factor => (
                    <div key={factor.id} className="bg-slate-800/50 rounded p-2.5">
                      ...
                      <p className="text-[11px] text-slate-400 leading-relaxed">{factor.message}</p>
