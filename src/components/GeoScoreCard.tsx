...
export const GeoScoreCard: React.FC<GeoScoreCardProps> = ({ result }) => {
 ...
 <p className="text-sm text-gray-500 mt-1">مدى قابلية الاقتباس من محركات البحث الذكية</p>
 </div>
 </div>
 ...
 <div className="font-bold text-sm text-gray-700">{factor.name}</div>
 ...
 <p className="text-xs text-gray-500">{factor.message}</p>
