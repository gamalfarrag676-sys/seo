...
const ToastItem = ({ toast, onRemove }: { toast: Toast, onRemove: () => void }) => {
 ...
 return (
 <div
 className={`flex items-center gap-3 px-4 py-3 rounded-xl border -sm shadow-lg transition-all duration-300 ${backgrounds[toast.type]} ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'
 }`}
 >
 {icons[toast.type]}
