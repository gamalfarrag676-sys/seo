...
export function TypewriterLoader() {
 ...
 <div className="w-24 h-24 rounded-3xl bg-blue-600 flex items-center justify-center shadow-sm">
 <Sparkles className="w-12 h-12 text-gray-900 animate-spin-slow" />
 </div>
 {/* Orbiting particles */}
 ...
 ? 'bg-blue-600 text-gray-900 shadow-sm scale-110'
 : index < currentStep
