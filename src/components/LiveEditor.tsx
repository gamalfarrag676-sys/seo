  ...
  return (
    <div className="glass-card overflow-hidden animate-fade-in-up">
        ...
        {tabs.map(tab => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="absolute bottom-0 inset-x-4 h-0.5 bg-gradient-to-l from-indigo-500 to-purple-500 rounded-full" />
              )}
            </button>
          );
        })}
      ...
      <div className="p-5 md:p-6 space-y-5">
          ...
          <div className="space-y-4 animate-fade-in-up" style={{ animationDuration: '0.3s' }}>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-500/10 border border-indigo-500/20">
                ...
                <span className="text-xs font-bold text-indigo-300">{wordCount} كلمة</span>
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="premium-input font-sans leading-relaxed"
                rows={16}
                dir="rtl"
            ...
            {productName && (
              <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-800/30 border border-slate-700/30">
                ...
                <span className="text-xs text-slate-500">المنتج: {productName}</span>
              </div>
            )}
          </div>
        )}
        ...
        {/* ===== Tab 2: Title & Meta ===== */}
        {activeTab === 'meta' && (
          <div className="space-y-5 animate-fade-in-up" style={{ animationDuration: '0.3s' }}>
            ...
            <div>
              ...
              <input
                ...
                className={`premium-input ${getStatusBorderColor(h1Validation.status)}`}
                dir="rtl"
            ...
            <div>
              ...
              <input
                ...
                className={`premium-input ${getStatusBorderColor(metaTitleValidation.status)}`}
                dir="rtl"
            ...
            <div>
              ...
              <textarea
                ...
                className={`premium-input ${getStatusBorderColor(metaDescValidation.status)}`}
                rows={3}
                dir="rtl"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="section-label mb-0">
                  <Link className="w-3.5 h-3.5 text-indigo-400 inline ml-1" />
                  رابط URL (Slug)
                </label>
                <div className="flex items-center gap-1.5">
              ...
              <input
                ...
                className={`premium-input font-mono text-sm ${getStatusBorderColor(urlSlugValidation.status)}`}
                dir="ltr"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="section-label mb-0">
                  <ImageIcon className="w-3.5 h-3.5 text-indigo-400 inline ml-1" />
              ...
              <input
                ...
                className={`premium-input ${getStatusBorderColor(altTextValidation.status)}`}
                dir="rtl"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="section-label mb-0">
                  <Tag className="w-3.5 h-3.5 text-indigo-400 inline ml-1" />
                  الكلمات المفتاحية
                </label>
                <div className="flex items-center gap-1.5">
              ...
              <textarea
                ...
                className={`premium-input ${getStatusBorderColor(keywordsValidation.status)}`}
                rows={2}
                dir="rtl"
